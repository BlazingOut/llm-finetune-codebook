...
### 2. 选择 Python 解释器
 ![[vscode_environment_setting.png]]
...
![[how_to_find_conda_environment.png]]
...
![[vscode_remote_ssh_extension.png]]

安装完成后，左侧状态栏会多出一个**远程资源管理器**图标（看起来像一个小电脑或两个尖括号 `><`）。

#### 第二步：添加远程连接

![[vscode_remote_ssh_link.png]]
